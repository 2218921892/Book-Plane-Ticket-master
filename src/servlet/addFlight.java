...
public class addFlight extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String first_class_num_str=req.getParameter("first_class_num");
		Integer first_class_num=Integer.parseInt(first_class_num_str);
		String business_class_num_str=req.getParameter("business_class_num");
		Integer business_class_num=Integer.parseInt(business_class_num_str);
		String economy_class_num_str=req.getParameter("economy_class_num");
		Integer economy_class_num=Integer.parseInt(economy_class_num_str);
		//������ȡ����
		...
		try {
			if(res.next()) {
				...
				out.println("新增失败，航班已经存在！");
				resp.setHeader("refresh", "5;url=admin/flight_add.jsp");
			}else {
				sql="insert into flight values('"+flight_id+"','"+start_place+"','"+end_place+"','"+start_airport+"','"+end_airport+"','"+take_off_time+"','"+landing_time+"','"+first_class_price+"','"+business_class_price+"','"+economy_class_price+"','"+first_class_num+"','"+business_class_num+"','"+economy_class_num+"')";
				//Integer res=
