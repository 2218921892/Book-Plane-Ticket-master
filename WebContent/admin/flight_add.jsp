					...
					<div class="panel-body" style="padding-bottom:30px;">
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label text-right" style="width:100px;">头等舱票数</label>
								<div class="col-sm-3" style="width:200px;">
									<input name="first_class_num" type="text" placeholder="例：10" class="form-control">
								</div>
								...
								<label class="col-sm-1 control-label text-right" style="width:100px;">商务舱票数</label>
								<div class="col-sm-3" style="width:200px;">
									<input name="business_class_num" type="text" placeholder="例：10" class="form-control">
								</div>
								...
								<label class="col-sm-1 control-label text-right" style="width:100px;">经济舱票数</label>
								<div class="col-sm-3" style="width:200px;">
									<input name="economy_class_num" type="text" placeholder="例：10" class="form-control">
								</div>
