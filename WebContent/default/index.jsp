			...
			<div>
				<%
					...
					while(res.next()){
						...
						String n1=res.getString(11);
						String n2=res.getString(12);
						String n3=res.getString(13);
				%>
				...
				<div class="collapse" id="collapseExample" style="display: block;">
					<div class="hangbanlist-body " style="background-color: #FEFCFC;">
						<ul class="list-inline">
							...
							<li class="w-percentage-25">座位数：<%=n1 %></li>
							...
							<li class="pull-right ">
								<% if(n1!=null && !n1.equals("0")){ %>
								<button type="button"
									class="btn btn-danger btn-sm"
									onClick="window.location.href ='order.jsp?flight_id=<%=f_i %>&grade=f';">订票</button>
								<%}else{ %>
								<button type="button"
										class="btn btn-danger btn-sm disabled">订票</button>
								<%} %>
							</li>
						</ul>
						<ul class="list-inline">
							<li class="w-percentage-20"><strong class=" red">商务舱(B)</strong></li>
							<li class="w-percentage-25">座位数：<%=n2 %></li>
						...
						<ul class="list-inline">
							...
							<li class="w-percentage-25">座位数：<%=n3 %></li>
